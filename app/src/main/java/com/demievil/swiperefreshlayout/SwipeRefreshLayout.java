...
import com.lsjwzh.widget.materialloadingprogressbar.CircleImageView;
import com.lsjwzh.widget.materialloadingprogressbar.MaterialProgressDrawable;

import org.zarroboogs.soundplayer.SoundPlayer;

/**
 * Created by andforce on 15/5/24.
 */
public class SwipeRefreshLayout extends ViewGroup {
    ...
    public SwipeRefreshLayout(Context context) {
        this(context, null);
        mSoundPlayer = SoundPlayer.getPlayer(context);
    }
